...
Справа отображаются только день недели, дата и время, например
`Sun 14 Jun  10:35`. Звук и яркость управляются аппаратными клавишами, поэтому
их постоянные индикаторы вместе с раскладкой и батареей скрыты из панели.
